...
namespace GUI {
    ...
    public partial class QLSVDataSet2 : global::System.Data.DataSet {
        ...
        public partial class LOPDataTable : global::System.Data.TypedTableBase<LOPRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public LOPRow AddLOPRow(string MALOP, string TENLOP, string MANGANH) {
...
namespace GUI.QLSVDataSet2TableAdapters {
    ...
    public partial class LOPTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[LOP] WHERE (([MALOP] = @Original_MALOP) AND ((@IsNull_TENLOP =" +
                " 1 AND [TENLOP] IS NULL) OR ([TENLOP] = @Original_TENLOP)) AND ((@IsNull_MANGANH" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[LOP] SET [MALOP] = @MALOP, [TENLOP] = @TENLOP, [MANGANH] = @MANGANH WHERE (([MALOP] = @Original_MALOP) AND ((@IsNull_TENLOP = 1 AND [TENLOP] IS NULL) OR ([TENLOP] = @Original_TENLOP)) AND ((@IsNull_MANGANH = 1 AND [MANGANH] IS NULL) OR ([MANGANH] = @Original_MANGANH)));
SELECT MALOP, TENLOP, MANGANH FROM LOP WHERE (MALOP = @MALOP)";
